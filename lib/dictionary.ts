...
{ es: 'yo', qu: 'ñuqa', ay: 'naya' },
{ es: 'tú', qu: 'qam', ay: 'juma' },
{ es: 'él', qu: 'pay', ay: 'jupa' },
{ es: 'ella', qu: 'pay', ay: 'jupa' },
{ es: 'nosotros', qu: 'ñuqanchik', ay: 'nayanaka' },
{ es: 'ellos', qu: 'paykuna', ay: 'jupanaka' },
{ es: 'a', qu: 'man', ay: 'aru' },
{ es: 'de', qu: 'manta', ay: 'manta' },
{ es: 'en', qu: 'pi', ay: 'pi' },
{ es: 'por', qu: 'rayku', ay: 'taki' },
{ es: 'para', qu: 'paq', ay: 'taki' },
{ es: 'con', qu: 'wan', ay: 'mpi' },
{ es: 'sin', qu: 'sin', ay: 'sin' },
{ es: 'sobre', qu: 'patapi', ay: 'patapi' },
{ es: 'entre', qu: 'chawpi', ay: 'chawpi' },
{ es: 'la', qu: 'lla', ay: 'lla' },
{ es: 'el', qu: 'el', ay: 'el' },
{ es: 'los', qu: 'los', ay: 'los' },
{ es: 'las', qu: 'las', ay: 'las' },
{ es: 'un', qu: 'un', ay: 'un' },
{ es: 'una', qu: 'una', ay: 'una' },
{ es: 'mi', qu: 'mi', ay: 'mi' },
{ es: 'tu', qu: 'tu', ay: 'tu' },
{ es: 'su', qu: 'su', ay: 'su' },
{ es: 'que', qu: 'que', ay: 'que' },
{ es: 'y', qu: 'y', ay: 'y' },
{ es: 'o', qu: 'o', ay: 'o' },

// --- PALABRAS Y FRASES COTIDIANAS ---
{ es: 'qué', qu: 'ima', ay: 'kamsa' },
{ es: 'pasa', qu: 'pasakun', ay: 'pasaskani' },
{ es: '¿qué pasa?', qu: '¿imaynallataq?', ay: '¿kamsarakisa?', phrase: true },
{ es: 'compañero', qu: 'masin', ay: 'amigu' },
{ es: 'amigo', qu: 'masin', ay: 'amigu' },
{ es: 'hermano', qu: 'wawqi', ay: 'jilata' },
{ es: 'hermana', qu: 'ñaña', ay: 'kullaka' },
{ es: 'señor', qu: 'tayta', ay: 'tata' },
{ es: 'señora', qu: 'mama', ay: 'mama' },
{ es: 'joven', qu: 'wayna', ay: 'wayna' },

// --- FRASES COTIDIANAS ---
{ es: '¿qué tal?', qu: '¿imaynallataq?', ay: '¿kamisaraki?', phrase: true },
{ es: '¿cómo va?', qu: '¿imaynallataq?', ay: '¿kamisaraki?', phrase: true },
{ es: 'todo bien', qu: 'llapan allinmi', ay: 'tukri waliki', phrase: true },
{ es: 'está bien', qu: 'allinmi', ay: 'waliki', phrase: true },
{ es: 'no pasa nada', qu: 'ima pasanchu', ay: 'jani pasaski', phrase: true },

// --- MÁS SUSTANTIVOS COMUNES ---
{ es: 'trabajo', qu: 'llamkay', ay: 'irna' },
{ es: 'familia', qu: 'ayllu', ay: 'ayllu' },
{ es: 'comunidad', qu: 'llaqta', ay: 'marka' },
{ es: 'fiesta', qu: 'raymi', ay: 'raymi' },
{ es: 'música', qu: 'taki', ay: 'taki' },
{ es: 'baile', qu: 'tusuy', ay: 'tusuy' },
{ es: 'canción', qu: 'takiy', ay: 'takiy' },
